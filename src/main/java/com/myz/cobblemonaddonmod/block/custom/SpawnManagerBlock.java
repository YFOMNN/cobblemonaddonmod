...
public class SpawnManagerBlock extends BlockWithEntity implements BlockEntityProvider {

    public static final DirectionProperty FACING = Properties.HORIZONTAL_FACING;

    public static final MapCodec<SpawnManagerBlock> CODEC = SpawnManagerBlock.createCodec(SpawnManagerBlock::new);
